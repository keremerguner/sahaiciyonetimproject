...
const MessageCard = ({message, onComplated, onNotComplated, onContinue}) => {
  ...
  } else if (message.complated === 'DEVAM EDİYOR...') {
    borderColor = '#FFD328'; // "complated" özelliği "HAZIR DEĞİL" ise arka plan rengini kırmızı yap
  }
  else if (message.complated === 'İPTAL EDİLDİ!') {
    borderColor = '#cf142b'; // "complated" özelliği "HAZIR DEĞİL" ise arka plan rengini kırmızı yap
  }
